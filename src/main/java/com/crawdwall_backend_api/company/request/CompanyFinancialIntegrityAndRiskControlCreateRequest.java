...
public record CompanyFinancialIntegrityAndRiskControlCreateRequest(
    ...
    @JsonProperty(required = true) boolean isPoliticallyExposedPerson,
    String pepRole,
    String pepCountry,
    Integer pepYear,
    @JsonProperty(required = true) boolean hasLitigationBankruptcyOrInsolvency,
    String litigationNature,
    Integer litigationYear,
    String litigationCurrentStatus,
    @JsonProperty(required = true) boolean isSubjectToSanctions,
