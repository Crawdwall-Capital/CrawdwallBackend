...
public class MailgunEmailSenderServiceImpl implements EmailSenderService {
    ...
    String senderEmail = "crawdwallcapital@gmail.com";
...
//    private String backendAcceptAdminInviteBaseUrl;
    ...
    @Async
    @Override
    public void sendCompanyAccountActivationEmail(String emailAddress, String firstName, String expiresAt, String otp) {
        try {
